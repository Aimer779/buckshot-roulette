 ...
 * Shows live/blank shell icons with counts.
    ...
    <div className="flex flex-col items-center gap-3">
      ...
      {showUnknown ? (
        <div className="flex items-center gap-2 flex-wrap justify-center max-w-[200px]">
          {remaining.map((shell, i) => (
            <motion.div
              key={`shell-${currentIndex + i}`}
            ...
            >
              {shell.revealed ? (
                <div
                  ...
                  style={{
                    backgroundColor: shell.type === 'live' ? 'var(--accent-red)' : 'var(--accent-blue-dim)',
                    boxShadow: shell.type === 'live'
